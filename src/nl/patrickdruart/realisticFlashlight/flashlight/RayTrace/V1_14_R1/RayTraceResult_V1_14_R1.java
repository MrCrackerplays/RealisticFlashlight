package nl.patrickdruart.realisticFlashlight.flashlight.RayTrace.V1_14_R1;
...
import org.bukkit.craftbukkit.v1_14_R1.CraftFluidCollisionMode;
import org.bukkit.craftbukkit.v1_14_R1.util.CraftRayTraceResult;
 ...
 */
public class RayTraceResult_V1_14_R1 implements IRayTrace {
	 ...
	 * @param result
	 */
	public RayTraceResult_V1_14_R1(org.bukkit.util.RayTraceResult result) {
		this.result = result;
	}
	 ...
	 */
	public RayTraceResult_V1_14_R1(Vector hitPosition) {
	 ...
	 */
	public RayTraceResult_V1_14_R1(Vector hitPosition, BlockFace hitBlockFace) {
	 ...
	 * @param hitBlockFace the hit block face
	 */
	public RayTraceResult_V1_14_R1(Vector hitPosition, Block hitBlock, BlockFace hitBlockFace) {
	 ...
	 */
	public RayTraceResult_V1_14_R1(Vector hitPosition, Entity hitEntity) {
	 ...
	 * @param hitBlockFace the hit block face
	 */
	public RayTraceResult_V1_14_R1(Vector hitPosition, Entity hitEntity, BlockFace hitBlockFace) {
		result = new org.bukkit.util.RayTraceResult(hitPosition, hitEntity, hitBlockFace);
	}

	public static RayTraceResult_V1_14_R1 rayTraceEntities(Location start, Vector direction, double maxDistance) {
	...
	public static RayTraceResult_V1_14_R1 rayTraceEntities(Location start, Vector direction, double maxDistance,
		...
		return (nearestHitEntity == null) ? null
				: new RayTraceResult_V1_14_R1(nearestHitResult.getHitPosition(), nearestHitEntity,
						nearestHitResult.getHitBlockFace());
	}

	public static RayTraceResult_V1_14_R1 rayTraceBlocks(Location start, Vector direction, double maxDistance) {
	...
	public static RayTraceResult_V1_14_R1 rayTraceBlocks(Location start, Vector direction, double maxDistance,
		...
		return (result == null) ? null : new RayTraceResult_V1_14_R1(result);
	}

	public static RayTraceResult_V1_14_R1 iteratorBlocks(Location start, Vector direction, double maxDistance,
			FluidCollisionModeFlash fluidCollisionMode, boolean ignorePassableBlocks) {
		BlockIterator blIt = new BlockIterator(start.getWorld(), start.toVector(), direction, 0d, (int) maxDistance);
		RayTraceResult_V1_14_R1 result = null;
		while (blIt.hasNext()) {
			...
			if ((block.isLiquid() && fluidCollisionMode != FluidCollisionModeFlash.NEVER)
				...
				result = new RayTraceResult_V1_14_R1(block.getLocation().toVector());
				break;
			}
		}
		return result;
